...
namespace ThiCSLT2.Class
{
    class function
    {
        ...
        public static void Connect()
        {
            ...
            ConnString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=E:\\QLCHgiaydep\\abc\\QLCHgiaydep\\ThiCSLT2\\ThiCSLT2\\database\\BTL_QLGD.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        public static string CreateKey(string tiento)
        {
            ...
            if (partsTime[2].Substring(3, 2) == "PM" && partsTime[2] != "12")
